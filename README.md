...
**Riverchain 智能投资决策系统** 是一个基于 AI 的信贷风控评估系统，采用多智能体评估框架，结合 Perplexity AI 提供全面、专业的风险分析服务。
...
### 3. 多智能体评估
- **核心分析师**: 基于 Riverchain 标准的严格风控评估
- **自定义智能体**: 可配置多个专家视角（如宏观经济专家、行业分析师等）
...
- **样式**: Tailwind CSS
- **状态管理**: Zustand
- **AI 集成**: Perplexity API (sonar-pro / sonar-reasoning)
...
### 2. 配置 API Key
启动应用后，点击右上角"设置"按钮，输入你的 Perplexity API Key。
